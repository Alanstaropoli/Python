...
# Creo 3 listas en donde van a estar los nombres de los alumnos y las notas de las 2 evaluaciones.
...
# Creo la lista definitiva con los nombres de los estudiantes y sus respectivas notas totales.
notas = list(zip(nombres, total_notas))

# Calculo el promedio de las notas totales de los alumnos.
suma = 0
for elemento in total_notas:
    suma += elemento
promedio = suma/len(total_notas)
print(f'El promedio de las notas totales de los alumnos es de {int(promedio)}.')

# Imprimo el listado de los alumnos con peores notas.    
